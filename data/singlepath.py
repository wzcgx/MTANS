...
class SingleData28(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x, y = pkload(path + 'data_f32_nnunet.pkl')
...
class ISLESData(Dataset):
    """ LA Dataset """
    def __init__(self, list_file, root='', for_train=False,
             return_target=True, crop=True, transform=None):
...
class ISLESData_unlab(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x = pkload(path + 'data_f32_nnunet.pkl')
...
class SingleData_unlab(Dataset):
    def __init__(self, list_file, root='', for_train=False,
            transforms=None, return_target=False, crop=True):
        paths, names = [], []
        with open(list_file) as f:
            for line in f:
                line = line.strip()
...
class SingleData323232(Dataset):
    def __init__(self, list_file, root='', for_train=False,
            transforms='', return_target=True, crop=True):
        paths, names = [], []
        with open(list_file) as f:
    ...
    def __getitem__(self, index):
        ...
        x, y = pkload(path + 'data_f32_MASSL32.pkl')
...
class SingleData32(Dataset):
    def __init__(self, list_file, root='', for_train=False,
            transform=None, return_target=True, crop=True):
        paths, names = [], []
        with open(list_file) as f:
            for line in f:
                line = line.strip()
    ...
    def __getitem__(self, index):
        ...
        x = np.load(path + 'img.npy')
        y = np.load(path + 'mask.npy')
        # transforms work with nhwtc
...
class SingleData128_32(Dataset):
    def __init__(self, list_file, root='', for_train=False,
            transform=None, return_target=True, crop=True):
        paths, names = [], []
        with open(list_file) as f:
    ...
    def __getitem__(self, index):
        ...
        x = np.load(path + '128x128x32_img.npy')
        y = np.load(path + '128x128x32_mask.npy')
        # transforms work with nhwtc
        sample = {'image': x, 'mask': y}
...
class SingleData64(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x, y = pkload(path + 'data_f32_64x64x64.pkl')
