...
# class CycleTwoStreamBatchSampler(Sampler):
    # def __init__(self, size, primary_indices, secondary_indices, batch_size, secondary_batch_size, num_samples=None, num_epochs=0):
